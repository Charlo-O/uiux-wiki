...
import {
  ...
  workspaceStructuredFields,
} from "./features/ai/aiConfig.js";
import { generateAiAnalysis, requestAiCompletion } from "./features/ai/aiClient.js";
import { buildRuleDebugData, formatMarkdownSpec, formatTicketExport } from "./features/ai/aiExport.js";
import {
  buildPatternComparisons,
  buildProjectTechStack,
  buildStructuredInputText,
  detectInteractionPoints,
  getQualityBreakdown,
  getQualityScore,
  getSpecDiffRows,
  getVersionSummary,
