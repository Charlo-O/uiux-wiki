...
var Exporter = (function () {
  ...
  async function exportVideo(P, aspect) {
    ...
    if (typeof VideoEncoder === "undefined" || typeof VideoFrame === "undefined") {
      UI.toast("当前浏览器不支持 WebCodecs，请使用新版 Chrome、Edge 或 Firefox");
      return;
    }
    busy = true;
    ...
    FX.celebrate("已保存 " + totalSec.toFixed(1) + " 秒视频 \u00b7 " + w + "\u00d7" + h + " @ " + fps + "fps");
